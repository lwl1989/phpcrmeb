...
class SpecialTask extends ModelBasic
{
    ...
    public static function getSpecialTaskOne($task_id) {
        ...
        return self::order('sort DESC')->field('id,special_id,title,detail,type,is_pay,link,image,abstract,sort,play_count,is_show,add_time,live_id,videoId,file_name,file_type')->find($task_id);
    }
