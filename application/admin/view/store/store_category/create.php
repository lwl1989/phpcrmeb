                    ...
                    <form action="" class="layui-form">
                        ...
                        <div class="layui-form-item submit">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="cate_name" style="width: 50%" v-model="formData.cate_name" autocomplete="off" placeholder="请输入分类名称" class="layui-input">
                            </div>
                        </div>
                         <div class="layui-form-item submit">
                            ...
                            <div class="layui-input-block">
                                <select name="pid" v-model="formData.pid" lay-search="" lay-filter="pid">
                                    ...
                                    <optgroup  v-for="item in cateList" >
