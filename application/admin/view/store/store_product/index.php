                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    ...
                                    <button class="layui-btn layui-btn-primary layui-btn-sm export"  lay-submit="search" lay-filter="export">
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <div class="layui-btn-container">
                        {switch name='type'}
                            {case value="1"}
                            <button class="layui-btn layui-btn-sm" onclick="action.open_add('{:Url('create')}','添加产品')">添加产品</button>
...
<!--                        <p>浏览量:{{d.browse}}</p>-->
                    ...
                    <script type="text/html" id="act">
                        <button type="button" class="layui-btn layui-btn-xs layui-btn-sm" onclick="action.open_add('{:Url('create')}?id={{d.id}}','编辑')">
