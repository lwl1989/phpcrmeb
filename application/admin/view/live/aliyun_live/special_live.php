...
<script>
    ...
    layList.tableList({
        ...
        return [
            ...
            {field: 'image', title: '封面图',templet:'#image',width:"8%",align: 'center'},
                ...
                $eb.$swal('delete',function(){
                    $eb.axios.get(url).then(function(res){
                        if(res.status == 200 && res.data.code == 200) {
                            layList.baseGet(layList.U({c:'special.special_type',a: 'video_upload_address_voucher',p:{type:4,videoId:data.videoId}}), function (res) {
                                var url=res.msg;
