...
<script>
    ...
    layList.tableList('List',"{:Url('get_live_record_list')}?stream_name={$stream_name}&record_id={$record_id}",function (){
        return [
            {field: 'stream_name', title: '直播间号',align:"center"},
            {field: 'playback_url', title: '地址',align:"center"},
            {field: 'StartTime', title: '开始时间',align:'center'},
            {field: 'EndTime', title: '结束时间',align:'center'},
            {field: 'is_show', title: '状态',templet:"#checkboxstatus",width:'10%'},
