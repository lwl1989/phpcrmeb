                        ...
                        <div class="layui-form-item m-t-5" v-cloak="">
                            ...
                            <div class="layui-form-item m-t-5" >
                                ...
                                <div class="layui-input-block">
                                    ...
                                    <button type="button" class="layui-btn layui-btn-sm layui-btn-normal" @click="uploadVideo()" v-show="is_upload==false">确认添加</button>
                ...
                createUploader:function () {
                    ...
                    var uploader = new AliyunUpload.Vod({
                        ...
                        addFileSuccess: function (uploadInfo) {
                            ...
                            }else if(special_type!=2 && arr[0]!='video'){
                                that.is_video=false;
                                that.videoWidth = 0;
