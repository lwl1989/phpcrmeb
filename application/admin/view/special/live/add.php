                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <select name="subject_id" v-model="formData.subject_id" lay-search=""
                                        ...
                                        <optgroup v-if="item.special_subject" v-for="item in subject_list"
                                                  :label="item.name">
                                            <option v-if="item.special_subject" :value="chaild_item.id"
                                                    v-for="chaild_item in item.special_subject">
                                                |----{{chaild_item.name}}
                                            </option>
                                        </optgroup>
                                    </select>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="title" v-model="formData.title" autocomplete="off"
                                           placeholder="请输入直播名称" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">直播简介</label>
                                <div class="layui-input-block">
                                    <textarea placeholder="请输入直播简介" v-model="formData.abstract"
                            ...
                            <div class="layui-form-item m-t-5">
                                ...
                                <div class="layui-input-block">
                                    <textarea placeholder="请输入直播短语" v-model="formData.phrase"
                                              class="layui-textarea"></textarea>
                                </div>
                            </div>
                            <div class="layui-form-item m-t-5">
                                ...
                                <div class="layui-input-block">
                                    <textarea placeholder="用户首次进入直播间的欢迎语" v-model="formData.auto_phrase"
                                              class="layui-textarea"></textarea>
                                </div>
                            </div>
                            <div class="layui-form-item m-t-5">
                            ...
                            <div class="layui-form-item m-t-5">
                                ...
                                <div class="layui-input-block">
                                    <div class="label-box" v-for="(item,index) in formData.label"
                            ...
                            <div class="layui-form-item m-t-5">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" name="live_time" v-model="formData.live_time" id="live_time"
                                               autocomplete="off" class="layui-input" placeholder="开播时间">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">开播提醒</label>
                                    <div class="layui-input-block">
                                        <input type="radio" name="is_remind" lay-filter="is_remind"
                                               v-model="formData.is_remind" value="1" title="是">
                                        <input type="radio" name="is_remind" lay-filter="is_remind"
                                               v-model="formData.is_remind" value="0" title="否">
                                    </div>
                                </div>
                                <div class="layui-form-item" v-show="formData.is_remind == 1">
                                    <label class="layui-form-label">提醒时间</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="time" lay-verify="number" id="remind_time"
                                               v-model="formData.remind_time" autocomplete="off" class="layui-input"
                                               placeholder="单位：分钟">
                                    </div>
                                </div>
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="number" name="time" lay-verify="number"
                                               v-model="formData.live_duration" autocomplete="off" class="layui-input"
                                               placeholder="单位：分钟">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="radio" name="is_recording" lay-filter="is_recording"
                                               v-model="formData.is_recording" value="1" title="是">
                                        <input type="radio" name="is_recording" lay-filter="is_recording"
                                               v-model="formData.is_recording" value="0" title="否">
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item m-t-5">
                        ...
                        <div class="layui-tab-item">
                            ...
                            <div class="layui-form-item m-t-5">
                                ...
                                <div class="layui-input-block">
                                    ...
                                    <button type="button" class="layui-btn layui-btn-fluid" @click='store_task'>
                                        点击选择商品
                                    </button>
                                </div>
                            </div>
                            <div class="layui-form-item m-t-5">
                                ...
                                <div class="layui-input-block">
                                    ...
                                    <table class="layui-hide" id="showStoreList" lay-filter=""></table>
                        ...
                        <div class="layui-tab-item">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    ...
                                    <input type="radio" name="pay_type" lay-filter="pay_type"
                                           v-model="formData.pay_type" value="2" title="加密">
                                </div>
                            </div>
                                ...
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" name="password" v-model="formData.password"
                                               lay-verify="password" placeholder="请输入密码" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-inline">
                                    <label class="layui-form-label">确认密码</label>
                                    <div class="layui-input-inline">
                                        <input type="text" name="qr_password" v-model="formData.qr_password"
...
<script>
    var id = {$id},
        ...
        storeCheckList = <?= isset($storeCheckList) ? $storeCheckList : "{}"?>;
        ...
        new Vue({
            ...
            data: {
                ...
                formData: {
                    ...
                    check_store_sure: storeCheckList ? storeCheckList : "",
                },
                but_title: '上传视频',
                link: '',
                label: '',
            ...
            methods: {
                ...
                show_source_list: function () {
                    ...
                    table.render({
                        ...
                        cols: [[
                            ...
                            {
                                field: 'right', title: '显示/隐藏', align: 'center', templet: function (d) {
                                    var is_checked = 1 ? "checked" : "";
                                    return "<input type='checkbox' name='delect' lay-skin='switch' value='" + d.id + "' lay-filter='delects' lay-text='显示|隐藏' " + is_checked + ">";
                                }
                            },
                        ]],
                    ...
                    //监听素材是否删除
                    form.on('switch(delects)', function (obj) {
                ...
                store_task: function () {
                    ...
                    layer.open({
                        ...
                        yes: function () {
                            ...
                            that.formData.check_store_sure = JSON.parse(source_tmp);
                ...
                show_store_list: function () {
                    ...
                    table.render({
                        ...
                        cols: [[
                            {field: 'id', title: '编号', sort: true, event: 'id', align: 'center'},
                            {field: 'store_name', title: '商品名称', edit: 'title', align: 'center'},
                            {
                                field: 'image',
                                title: '封面',
                                templet: '<div><img src="{{ d.image }}" style="width: 80px;height: 40px;"></div>',
                    ...
                    form.on('switch(delect)', function (obj) {
                        if (that.formData.check_store_sure) {
                            for (var i = 0; i < that.formData.check_store_sure.length; i++) {
                                if (that.formData.check_store_sure[i].id == obj.value) {
