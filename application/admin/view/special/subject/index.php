            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <div class="layui-btn-container">
                        <button type="button" class="layui-btn layui-btn-sm"><a href="{:Url('admin/special.grade/index')}" style="color: #ffffff">返回一级</a></button>
                        <button type="button" class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('admin/special.grade/create')}?level=2',{h:500,w:800})">添加分类</button>
                    ...
                    <script type="text/html" id="act">
                        <button class="layui-btn layui-btn-xs" onclick="$eb.createModalFrame('{{d.name}}-编辑','{:Url('admin/special.grade/create')}?sid={{d.id}}&level=2',{h:500,w:800})">
