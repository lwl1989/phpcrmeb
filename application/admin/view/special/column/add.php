...
{block name='script'}
<script>
    var id = {$id},special =<?=isset($special) ? $special : "{}"?>,sourceCheckList =<?= isset($sourceCheckList) ? $sourceCheckList : "{}"?>;
                ...
                show_source_list: function () {
                    ...
                    table.render({
                        ...
                        cols: [[
                            ...
                            {field: 'image', title: '封面', align: 'center', templet: '<div><img src="{{ d.image }}" style="width: 80px;height: 40px;"></div>'},
                            {
