...
<script type="text/javascript">
    ...
    layList.tableList('List',"{:Url('get_pink_list')}?cid={$cid}",function (){
        return [
            {field: 'uid', title: '开团团长',templet:'#uid',align: 'center',width:'12%'},
            {field: 'order_id', title: '订单号',align: 'center',width:'16%'},
            {field: 'add_time', title: '开团时间',align: 'center',width:'10%'},
            {field: 'stop_time', title: '结束时间',align: 'center',width:'10%'},
            {field: 'title', title: '拼团产品',templet:'#title',align: 'center',width:'16%'},
            {field: 'people', title: '拼团情况',templet:'#people',width:'5%',align: 'center'},
            {field: 'people_true', title: '拼团人数',width:'5%',align: 'center'},
            {field: 'status', title: '状态',templet:'#status',width:'5%',align: 'center'},
            {field: 'info', title: '查看详情',templet:'#info',align: 'center',width:'8%'},
